...
{
    public const CALLBACK_11 = [self::class, 'callback11'];
    public const CALLBACK_12 = [self::class, 'callback12'];
    public const CALLBACK_21 = [self::class, 'callback21'];
    public const CALLBACK_22 = [self::class, 'callback22'];

    /**
     * @var int
     */
    private static int $callback11Counter;

    /**
     * @var int
     */
    private static int $callback12Counter;

    /**
     * @var int
     */
    private static int $callback21Counter;

    /**
     * @var int
     */
    private static int $callback22Counter;
    ...
    public function testRuleFirstApplicable()
    {
        ...
        // here we rely on knowledge if internal structure of the result (it's not intended for direct usage)
        $value = $result[BaseAlgorithm::EVALUATION_VALUE];
    ...
    public function testRulePermitUnlessDeny()
    {
        ...
        // here we rely on knowledge if internal structure of the result (it's not intended for direct usage)
        $value = $result[BaseAlgorithm::EVALUATION_VALUE];
        $advice = $result[BaseAlgorithm::EVALUATION_ADVICE];
    ...
    public function testPoliciesOrSetsFirstApplicable()
    {
        ...
        // here we rely on knowledge if internal structure of the result (it's not intended for direct usage)
        $this->assertEquals(EvaluationEnum::DENY, $result[BaseAlgorithm::EVALUATION_VALUE]);
        ...
        // here we rely on knowledge if internal structure of the result (it's not intended for direct usage)
        $this->assertEquals(EvaluationEnum::PERMIT, $result[BaseAlgorithm::EVALUATION_VALUE]);
    }
     ...
     * @return bool
     */
    public static function logicalFalse(): bool
    {
        return false;
    }
